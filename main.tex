...
%
To reach our objective, we iteretevly 
\begin{enumerate*}[label=(\roman*)]
...
\end{enumerate*}
%
Currently, we mainly focus on Bulding Block level, because, from our point of view, 
it is the best point to apply learning. %%improve settings
%
Our test application is the gradient from a source zone, a idiomatic pattern useful for field based calculus for creating different collective behaviour
ranging to distributed sensing, information diffusion and to build other complex pattern like Self-organising coordination regions~\cite{DBLP:conf/coordination/CasadeiPVN19}.
Gradient suffers of slow rising up and differnet hand-crafted solution have been built.
Our goal is to reach a similar perform of the best hand-crafted solution (called ULT gradient~\cite{DBLP:conf/saso/AudritoCDV17}).
%
%cite repos,
%
