...
It is worth noting that no convergence theorem to global optimal policy exists in Multi-Agent settings. 
Usually, Nash Equilibrium~\cite{DBLP:conf/icml/HuW98} is proved to assess a good Multi-Agent learning algorithm, but it has not the same meaning of a global optimal policy.
%
