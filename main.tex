...
%% writinig about the representation problems, solve in similar problem (graphs) using Graph Neural Network
%% writing about the non stationaritn problems, solved using deep learning model and "mind representation"
%% writing about the large scale problems (tackled in the thesis)
