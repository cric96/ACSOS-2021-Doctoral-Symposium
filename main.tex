...
%
Recent works~\cite{DBLP:journals/aamas/Hernandez-LealK19} exploring the application of deep neural networks model in Multi-Agents context to solve well-known problems (non-stationary, partial observability, large state space, etc.). 
%
